...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Docker Logger</a><button class="navbar-toggler navbar-toggler-right text-uppercase font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu <i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Logs</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">Docker Logger</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Docker logger is proudly running</p>
                <p class="masthead-subheading font-weight-light mb-0"><?php echo passthru('docker -v'); ?></p>
            </div>
            <?php 
                $containerNames = shell_exec("docker ps --format '{{.Names}}' 2>&1");
                $output = preg_replace('/\s+/', ' ', $containerNames);
                if (!empty($output)) {
                    $containerArr = explode(' ', $output);
                }
            ?>
            <?php if (!empty($containerArr)) : ?>
                <select>
                    <option value='0'>Select a container</option>
                    <?php foreach ($containerArr as $container) : ?>
            ...
            <div class="row">
                ...
                <?php 
                    ...
                    // function 
                    $output = shell_exec("docker logs policyhubapi-php 2>&1");
